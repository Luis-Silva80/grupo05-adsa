...
import { defineNetExterno } from './configuracaoDeIp';
// import AOS from 'aos';
...
function Home() {
    ...
    function buscarListaDeIps() {

        defineNetExterno()


        if (localStorage.getItem('ipWeb2') == 'true') {

            var element = document.querySelector(".button_link");
            element.style.backgroundColor = '#8C8C8C';
